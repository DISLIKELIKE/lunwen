            ...
            <el-aside width="200px">
                ...
                <el-menu default-active="/home/dangan">
                    <el-sub-menu index="1">
                        ...
                        <el-menu-item-group>
                            <el-menu-item index="/home/dangan" @click="open('dangan')">查看工程档案列表</el-menu-item>
                        </el-menu-item-group>
                    </el-sub-menu>
                    <el-sub-menu index="2">
                        <template #title>
                    ...
                    <el-sub-menu index="5">
                        ...
                        <el-menu-item-group>
                            <el-menu-item index="5-1" @click="open('dalx')">查看工程档案类型列表</el-menu-item>
                        </el-menu-item-group>
                    </el-sub-menu>
                    <el-sub-menu index="6">
                        <template #title>
                        ...
                        <el-menu-item-group>
                            <el-menu-item index="6-1" @click="open('daly')">查看工程档案来源列表</el-menu-item>
                        </el-menu-item-group>
                    </el-sub-menu>
                    <el-sub-menu index="7">
                        <template #title>
                    ...
                    <el-sub-menu index="9">
                        ...
                        <el-menu-item-group>
                            <el-menu-item index="9-1" @click="open('dals')">查看工程档案操作历史</el-menu-item>
                        </el-menu-item-group>
                    </el-sub-menu>
                </el-menu>
            </el-aside>
