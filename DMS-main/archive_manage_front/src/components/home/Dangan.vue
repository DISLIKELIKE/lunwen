        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="lujing" label="电子档案" width="150">
                <template v-slot="scope">
                    <el-link type="primary" :href="'http://192.168.0.100:82' + scope.row.lujing">查看电子档案</el-link>
                </template>
            </el-table-column>
    ...
    <el-dialog :model-value="status" @close="status = false">
        <el-form :model="form" label-width="120px" ref="formRef">
            ...
            <el-form-item label="路径" required prop="lujing">
                <el-upload action="http://127.0.0.1:82/upload/file" :headers="headers" :on-success="handleAvatarSuccess"
